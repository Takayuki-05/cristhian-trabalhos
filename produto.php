    ...
    <body>
        ...
        <div class="container">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">
						<a href="#" style="text-decoration: none; color: #363636;">
							<b>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<h3><b>Pão Francês com gergelim (kg)</b></h3>
					<br>
					Avaliação:<br>
					...
					<h4 style="color: #608A66;">
						<b>Preço:</b> R$ 12,79 (kg) à vista no pix.
						<span class="badge text-bg-warning">&nbsp;20% OFF&nbsp;</span>
					</h4>
					
					
					<img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc3dcaQtCUS9V63Z_LG_IlcK10DNVrtjWyPg&s" width="310">
